var DonatBoss = (() => {
  ...
  function OwnerDashboard() {
    ...
    const branchStats = branches
      ...
      .map((b) => {
        ...
        return { ...b, omzet: bO, modal: bHppDistrib, hppTerjual: bHppTerjual, hppTidakLaku: bHppTidakLaku, peng: bPL, laba: bO - bHppDistrib - bPL, txCount: bTx.length };
      });
    const mc = {};
  ...
  function OwnerSetting({ stab, setStab, pushNotif }) {
    const TABS = ["hpp", "paket", "cabang", "akun", "investor", "branding", "stok", "data"];
    const TLABEL = { hpp: "Menu HPP", paket: "Box/Paket", cabang: "Cabang", akun: "Akun", investor: "Investor", branding: "Logo", stok: "Stok Lapak", data: "Data" };
    return React.createElement("div", null,
      React.createElement("div", { className: "tabs tabs-sm" },
