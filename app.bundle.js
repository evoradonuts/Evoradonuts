var DonatBoss = (() => {
  ...
  // ─── OwnerProduksiCK — Rekap Produksi Central Kitchen ─────────────────────
  function OwnerProduksiCK({ pushNotif }) {
    ...
    const byMenu = {};
    filtered.forEach((p) => {
      const key = p.menuNama || p.menuId || "?";
      byMenu[key] = (byMenu[key] || 0) + (p.jumlah || 0);
    });
    const byMenuArr = Object.entries(byMenu).sort((a, b) => b[1] - a[1]);

    // Rekap per cabang CK
    const ckBranches = branches.filter((b) => b.type === "central_kitchen");
    const byBranch = ckBranches.map((b) => {
      const bRows = filtered.filter((p) => p.branchId === b.id);
      return { ...b, total: bRows.reduce((a, p) => a + (p.jumlah || 0), 0), rows: bRows };
    });
    ...
    return React.createElement("div", null,
      React.createElement("h3", { className: "section-title mt8" }, "Rekap Produksi Central Kitchen"),
      ...
      React.createElement("div", { className: "kpi-grid" },
        React.createElement("div", { className: "kpi-card kpi-omzet" },
          ...
          React.createElement("div", { className: "kpi-val" }, totalPcs, " pcs")
        ),
        React.createElement("div", { className: "kpi-card kpi-modal" },
          React.createElement("div", { className: "kpi-label" }, "Jenis Produk"),
          React.createElement("div", { className: "kpi-val" }, byMenuArr.length, " item")
        ),
        React.createElement("div", { className: "kpi-card kpi-cab" },
          React.createElement("div", { className: "kpi-label" }, "Entri Catatan"),
          React.createElement("div", { className: "kpi-val" }, filtered.length, "x")
        )
      ),
      // Rekap per produk
          ...
          React.createElement("table", { className: "tbl" },
            React.createElement("thead", null,
              React.createElement("tr", null,
                ...
                React.createElement("th", null, "Total Pcs"),
                React.createElement("th", null, "%")
              )
            ),
            React.createElement("tbody", null,
              byMenuArr.map(([nama, jml]) =>
                React.createElement("tr", { key: nama },
      ...
      byDateArr.length > 0 && React.createElement("div", { className: "mt12" },
        React.createElement("h4", { className: "sub-title" }, "Riwayat Harian"),
              ...
              rows.map((p) =>
                React.createElement("div", { key: p.id, className: "peng-row" },
                  ...
                  React.createElement("div", { className: "peng-right" },
                    ...
                    React.createElement("button", { className: "btn-danger-sm", style: { marginLeft: 8 }, onClick: () => {
