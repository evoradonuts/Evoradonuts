var DonatBoss = (() => {
  ...
  var S = /* @__PURE__ */ (() => {
    ...
    const stopRealtime = () => { channels.forEach((ch) => { try { sb.removeChannel(ch); } catch {} }); channels = []; };
  ...
  var fmtTs = (v) => { if (!v) return "-"; try { return (/* @__PURE__ */ new Date(v)).toLocaleString("id-ID"); } catch { return String(v); } };
  ...
  function Notif({ msg, type, onClose }) {
    useEffect(() => { const t = setTimeout(onClose, 4e3); return () => clearTimeout(t); }, [onClose]);
  ...
  function LoginPage() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "login-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "login-card" }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 52, textAlign: "center" } }, "EVORA"), /* @__PURE__ */ React.createElement("h1", { className: "login-title" }, "DONAT"), /* @__PURE__ */ React.createElement("p", { className: "login-sub" }, "Masuk privat menggunakan Kata Sandi tanpa tautan email."), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Nama User / Username / Email"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: username, onChange: (e) => setUsername(e.target.value), onKeyDown: (e) => e.key === "Enter" && doLogin(), placeholder: "Ketik nama user atau email..." })), /* @__PURE__ */ React.createElement("div", { className: "field-group", style: { marginTop: 8 } }, /* @__PURE__ */ React.createElement("label", null, "Kata Sandi (Password)"), /* @__PURE__ */ React.createElement("input", { className: "inp", type: "password", value: password, onChange: (e) => setPassword(e.target.value), onKeyDown: (e) => e.key === "Enter" && doLogin(), placeholder: "Masukkan kata sandi..." })), err && /* @__PURE__ */ React.createElement("p", { style: { color: "#ef4444", fontSize: 13, marginTop: 4 } }, err), /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-full", onClick: doLogin, disabled: busy, style: { marginTop: 12 } }, busy ? "Memverifikasi..." : "Masuk"), /* @__PURE__ */ React.createElement("p", { className: "login-hint" }, "Info Operasional: Kasir & Investor cukup ketik nama pendek tanpa tanda keong, cukk!")));
  }

  function WorkerPage({ pushNotif, me, mode = "worker" }) {
    const tick = useStoreTick();
    const [tab, setTab] = useState(() => localStorage.getItem("evora_tab") || "kasir");
    const [cart, setCart] = useState(() => { try { const saved = localStorage.getItem("evora_cart"); return saved ? JSON.parse(saved) : []; } catch { return []; } });
    ...
    const submitTx = () => {
      ...
      setCart([]); localStorage.removeItem("evora_cart");
    ...
    const saveEdit = (txId, newItems, alasan) => {
      ...
      setEditModal(null); pushNotif("Transaksi diperbarui. Owner diberitahu.", "warning");
    };
    ...
    const doSetoran = () => {
      ...
      setSetoran(entry); pushNotif("Setoran dikirim ke Owner!", "success");
    };
    ...
    const todayAbs = useMemo(() => {
      const all = S.get("absensi") || []; return all.find((a) => a.user_id === userId && a.date === today()) || null;
    }, [tick, userId]);
    ...
    const doCheckin = () => {
      ...
      if (ex?.checkin_ts) { pushNotif("Kamu sudah check-in hari ini.", "warning"); return; }
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "page" }, 
      /* @__PURE__ */ React.createElement("div", { className: "page-header" }, 
        ...
        /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", null, "Halaman Kasir"), /* @__PURE__ */ React.createElement("p", { className: "page-sub" }, curBranch?.name || "\u2014", curBranch?.workers?.length ? " - " + curBranch.workers.join(", ") : ""))
      ), 
      ...
      tab === "kasir" && /* @__PURE__ */ React.createElement("div", { className: "kasir-layout" }, 
        ...
        /* @__PURE__ */ React.createElement("div", { className: "cart-section" }, 
          ...
          cart.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "cart-total" }, "Total: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(totalBayar))), /* @__PURE__ */ React.createElement("div", { className: "row-wrap" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary", onClick: () => { setCart([]); localStorage.removeItem("evora_cart"); } }, "Batal"), /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: submitTx }, "Simpan Transaksi"))), 
      ...
      tab === "absensi" && /* @__PURE__ */ React.createElement("div", null, 
        ...
        /* @__PURE__ */ React.createElement("div", { className: "form-card" }, /* @__PURE__ */ React.createElement("div", { className: "row-wrap", style: { justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700 } }, "Hari ini"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#9a9690" } }, "Check-in: ", fmtTs(todayAbs?.checkin_ts), " | Check-out: ", fmtTs(todayAbs?.checkout_ts))), /* @__PURE__ */ React.createElement("div", { className: "row-wrap" }, /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: doCheckin }, "Check-in"), /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: doCheckout }, "Check-out")))), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group mt8" }, /* @__PURE__ */ React.createElement("label", null, "Rekap Bulan"), /* @__PURE__ */ React.createElement("input", { type: "month", className: "inp inp-sm", value: absMonth, onChange: (e) => setAbsMonth(e.target.value) })), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-grid" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-omzet" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Hadir"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, (monthSnap ? monthSnap.total_hadir : calcMonth.hadir), " hari")), /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-profit" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Jam"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, Math.round(((monthSnap ? monthSnap.total_menit : calcMonth.menit) || 0) / 60 * 10) / 10, " jam"))), 
  ...
  function OwnerDashboard() {
    ...
    const chart7 = [];
    for (let i = 6; i >= 0; i--) {
      const d = /* @__PURE__ */ new Date(); d.setDate(d.getDate() - i); const ds = d.toISOString().slice(0, 10);
  ...
  function PengeluaranOwner({ pushNotif }) {
    ...
    const refresh = () => setList(getList());
    const KATEGORI = [
      { value: "gaji_pekerja", label: "Gaji Pekerja Lapak" }, { value: "gaji_kitchen", label: "Gaji Central Kitchen" },
      { value: "bahan_baku", label: "Bahan Baku" }, { value: "operasional", label: "Operasional" },
      { value: "sewa", label: "Sewa Tempat" }, { value: "lainnya", label: "Lainnya" }
    ];
    const CHIPS = {
      gaji_pekerja: ["Gaji Kasir Pagi", "Gaji Kasir Siang", "Bonus Pekerja"], gaji_kitchen: ["Gaji Chef", "Gaji Helper", "Lembur Kitchen"],
      bahan_baku: ["Restok Tepung", "Restok Kentang", "Restok Minyak", "Restok Gas"], operasional: ["Listrik", "Air", "Internet"],
      sewa: ["Sewa Lapak", "Sewa Dapur"], lainnya: ["Lain-lain"]
    };
    const tambah = () => {
      if (!form.keterangan || !form.jumlah) { alert("Isi semua kolom!"); return; }
      ...
      setForm((f) => ({ ...f, keterangan: "", jumlah: "" })); refresh(); pushNotif("Pengeluaran dicatat!", "success");
    };
  ...
  function OwnerAbsensi({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "filter-bar mb8" }, /* @__PURE__ */ React.createElement("input", { type: "month", className: "inp inp-sm", value: month, onChange: (e) => setMonth(e.target.value) }), /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: selBranch, onChange: (e) => setSelBranch(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "Semua Cabang"), branches.map((b) => /* @__PURE__ */ React.createElement("option", { key: b.id, value: b.id }, b.name))), /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: lockMonth }, "Kunci Rekap"), /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: unlockMonth }, "Buka Kunci")), /* @__PURE__ */ React.createElement("div", { className: "kpi-grid" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-omzet" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Hadir"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, totalHadir, " hari")), /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-profit" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Jam"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, Math.round(totalMenit / 60 * 10) / 10, " jam")), /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-cab" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Pekerja"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, rows.length))), /* @__PURE__ */ React.createElement("h3", { className: "section-title mt12" }, "Detail Absensi Bulanan"), rows.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada pekerja / data profiles belum termuat."), rows.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.w.user_id, className: "peng-row", style: { flexDirection: "column", alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { className: "peng-info", style: { width: "100%", marginBottom: "4px" } }, /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, r.w.display_name || r.w.email || r.w.user_id.slice(0, 6)), /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, "Cabang: ", branches.find((b) => b.id === r.w.branchId)?.name || r.w.branchId || "-", " | Hadir: ", r.hadir, " | Jam: ", Math.round(r.menit / 60 * 10) / 10, r.locked ? " | (Terkunci)" : "")), /* @__PURE__ */ React.createElement("div", { style: { paddingLeft: "8px", borderLeft: "2px solid #555", width: "100%", marginTop: "4px" } }, r.history.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: "12px", color: "#888" } }, "Belum ada riwayat absen") : r.history.map(h => /* @__PURE__ */ React.createElement("div", { key: h.id, style: { fontSize: "12px", color: "#ccc", marginBottom: "2px" } }, "• ", h.date, " : Masuk ", getJam(h.checkin_ts), " - Keluar ", h.checkout_ts ? getJam(h.checkout_ts) : "Belum"))))));
  }
  ...
  function SettingData({ pushNotif }) {
      ...
      try {
        for (const t of tables) {
          ...
          if (selDate) {
            ...
            else if (["setoranBulanan", "absensiBulanan"].includes(t)) { const targetBulan = selDate.slice(0, 7); query = query.eq("bulan", targetBulan); }
          }
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Bersihkan Data"), /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Pilih cabang dan tanggal untuk menghapus data spesifik. Jika dibiarkan kosong, maka akan menghapus SEMUA data."), /* @__PURE__ */ React.createElement("div", { className: "filter-bar mb8" }, /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: selBranch, onChange: (e) => setSelBranch(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Semua Cabang --"), branches.map(b => /* @__PURE__ */ React.createElement("option", { key: b.id, value: b.id }, b.name))), /* @__PURE__ */ React.createElement("input", { type: "date", className: "inp inp-sm", value: selDate, onChange: (e) => setSelDate(e.target.value) })), /* @__PURE__ */ React.createElement("div", { className: "form-card mt8" }, /* @__PURE__ */ React.createElement("h4", null, "Eksekusi Hapus"), /* @__PURE__ */ React.createElement("div", { className: "row-wrap", style: { gap: 8, flexWrap: "wrap", marginTop: 8 } }, /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", disabled: busy, onClick: () => doClear("Laporan & Transaksi", ["transactions"], ["transactions"]) }, "Hapus Transaksi"), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", disabled: busy, onClick: () => doClear("Pengeluaran", ["pengeluaranLapak", "pengeluaranOwner"], ["pengeluaranLapak", "pengeluaranOwner"]) }, "Hapus Pengeluaran"), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", disabled: busy, onClick: () => doClear("Setoran", ["setoranHarian", "setoranBulanan"], ["setoranHarian", "setoranBulanan"]) }, "Hapus Setoran"), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", disabled: busy, onClick: () => doClear("Absensi", ["absensi", "absensiBulanan"], ["absensi", "absensiBulanan"]) }, "Hapus Absensi"), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", disabled: busy, onClick: () => doClear("Edit Log", ["editLog"], ["editLog"]) }, "Hapus Edit Log"))));
  }
  ...
  function EditMenuModal({ menu, bahan, isPaket, onSave, onClose }) {
    ...
    const handleUpload = async (e) => {
      ...
      if (!file) return;
      if (file.size > 2 * 1024 * 1024) { alert("Ukuran foto terlalu besar! Maksimal 2MB bos."); return; }
      setUploading(true);
      try {
      ...
      } catch (err) { alert(err?.message || "Gagal upload foto."); } finally { setUploading(false); }
    };
  ...
  function SettingAkun({ pushNotif }) {
    ...
    const createInvite = async () => {
      ...
      try {
        ...
        setForm((f) => ({ ...f, email: "", password: "", displayName: "" })); refreshInvites();
      } catch (e) { pushNotif(e?.message || String(e), "warning"); }
    };
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      ...
      /* @__PURE__ */ React.createElement("div", { className: "form-card mt8" }, 
        /* @__PURE__ */ React.createElement("h4", null, "Buat Akun Baru"), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Role"), /* @__PURE__ */ React.createElement("div", { className: "role-tabs" }, /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (form.role === "worker" ? " active" : ""), onClick: () => setForm((f) => ({ ...f, role: "worker" })) }, "Pekerja"), /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (form.role === "investor" ? " active" : ""), onClick: () => setForm((f) => ({ ...f, role: "investor" })) }, "Investor"), /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (form.role === "owner" ? " active" : ""), onClick: () => setForm((f) => ({ ...f, role: "owner" })) }, "Owner"))), 
  ...
  function App() {
    ...
    const syncAfterLogin = useCallback(async (session) => {
      ...
      try {
        ...
        if (error) throw error;
        if (!prof || prof.role === "none") { pushNotif("Akun kamu belum diundang oleh Owner.", "warning"); await sb.auth.signOut(); return; }
