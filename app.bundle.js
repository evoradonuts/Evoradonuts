var DonatBoss = (() => {
  ...
  // Patch keamanan untuk hapus akun langsung
  try {
  ...
  var S = /* @__PURE__ */ (() => {
    ...
    // Fitur Lokal
    const LOCAL_KEYS = /* @__PURE__ */ new Set(["notified_ids", "jadwalLibur"]);
    let cache = {};
    let channels = [];
  ...
  var fmtTs = (v) => { 
    if (!v) return "-"; 
    try { return (/* @__PURE__ */ new Date(v)).toLocaleString("id-ID"); } 
  ...
  function Modal({ title, onClose, children }) {
    return /* @__PURE__ */ React.createElement("div", { className: "modal-backdrop", onClick: onClose }, 
      /* @__PURE__ */ React.createElement("div", { className: "modal-box", onClick: (e) => e.stopPropagation() }, 
        /* @__PURE__ */ React.createElement("div", { className: "modal-header" }, 
          /* @__PURE__ */ React.createElement("span", null, title), 
          /* @__PURE__ */ React.createElement("button", { className: "btn-icon", onClick: onClose }, "X")
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "modal-body" }, children)
      )
    );
  }
  ...
  function Notif({ msg, type, onClose }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "notif notif-" + type }, 
      /* @__PURE__ */ React.createElement("span", { style: { flex: 1 } }, msg), 
      /* @__PURE__ */ React.createElement("button", { onClick: onClose }, "X")
    );
  }

  function BarChart({ data, height }) {
    const max = Math.max(...data.map((d) => Math.max(d.v1 || 0, d.v2 || 0)), 1);
    return /* @__PURE__ */ React.createElement("div", { className: "bar-chart", style: { height: (height || 100) + 24 } }, 
      data.map((d, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "bar-col" }, 
        /* @__PURE__ */ React.createElement("div", { className: "bar-wrap", style: { height: height || 100 } }, 
          /* @__PURE__ */ React.createElement("div", { className: "bar-fill bar-a", style: { height: (d.v1 || 0) / max * 100 + "%" } }), 
          /* @__PURE__ */ React.createElement("div", { className: "bar-fill bar-b", style: { height: (d.v2 || 0) / max * 100 + "%" } })
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "bar-label" }, d.label)
      ))
    );
  }
  ...
  function LoginPage() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "login-wrap" }, 
      /* @__PURE__ */ React.createElement("div", { className: "login-card" }, 
        ...
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, 
          /* @__PURE__ */ React.createElement("label", null, "Nama User / Username / Email"), 
          /* @__PURE__ */ React.createElement("input", { className: "inp", value: username, onChange: (e) => setUsername(e.target.value), onKeyDown: (e) => e.key === "Enter" && doLogin(), placeholder: "Ketik nama user atau email..." })
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group", style: { marginTop: 8 } }, 
          /* @__PURE__ */ React.createElement("label", null, "Kata Sandi (Password)"), 
          /* @__PURE__ */ React.createElement("input", { className: "inp", type: "password", value: password, onChange: (e) => setPassword(e.target.value), onKeyDown: (e) => e.key === "Enter" && doLogin(), placeholder: "Masukkan kata sandi..." })
        ), 
        err && /* @__PURE__ */ React.createElement("p", { style: { color: "#ef4444", fontSize: 13, marginTop: 4 } }, err), 
        /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-full", onClick: doLogin, disabled: busy, style: { marginTop: 12 } }, busy ? "Memverifikasi..." : "Masuk"), 
        /* @__PURE__ */ React.createElement("p", { className: "login-hint" }, "Info Operasional: Kasir & Investor cukup ketik nama pendek tanpa tanda keong, cukk!")
      )
    );
  }
  ...
  function WorkerPage({ pushNotif, me, mode = "worker" }) {
    ...
    const doCheckout = () => {
      ...
      const d = today();
      const ex = all.find((a) => a.user_id === userId && a.date === d);
      if (!ex?.checkin_ts) { pushNotif("Kamu belum check-in hari ini.", "warning"); return; }
      if (ex?.checkout_ts) { pushNotif("Kamu sudah check-out hari ini.", "warning"); return; }
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "page" }, 
      /* @__PURE__ */ React.createElement("div", { className: "page-header" }, 
        /* @__PURE__ */ React.createElement("img", { className: "page-icon", src: "./logo.jpg", style: { width: 45, height: 45, objectFit: "cover", borderRadius: 10, padding: 0 } }), 
        /* @__PURE__ */ React.createElement("div", null, 
          /* @__PURE__ */ React.createElement("h2", null, "Halaman Kasir"), 
          /* @__PURE__ */ React.createElement("p", { className: "page-sub" }, curBranch?.name || "\u2014", curBranch?.workers?.length ? " - " + curBranch.workers.join(", ") : "")
        )
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "row-wrap mb8" }, 
        /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: branchId, onChange: (e) => setBranchId(e.target.value), disabled: !!me?.branchId }, branches.map((b) => /* @__PURE__ */ React.createElement("option", { key: b.id, value: b.id }, b.name))), 
        /* @__PURE__ */ React.createElement("input", { type: "date", className: "inp inp-sm", value: txDate, onChange: (e) => setTxDate(e.target.value) })
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "tabs" }, TABS.map((t) => /* @__PURE__ */ React.createElement("button", { key: t, className: "tab" + (tab === t ? " active" : ""), onClick: () => setTab(t) }, TAB_LABELS[t]))), 
      
      tab === "kasir" && /* @__PURE__ */ React.createElement("div", { className: "kasir-layout" }, 
        /* @__PURE__ */ React.createElement("div", null, 
          /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Menu Satuan"), 
          /* @__PURE__ */ React.createElement("div", { className: "menu-grid" }, menus.filter((m) => m.tipe !== "paket").map((m) => /* @__PURE__ */ React.createElement("button", { key: m.id, className: "menu-card", onClick: () => addToCart(m), style: { padding: 0, overflow: "hidden", display: "flex", flexDirection: "column", height: "100%" } }, m.imgUrl ? /* @__PURE__ */ React.createElement("img", { src: m.imgUrl, style: { width: "100%", height: "90px", objectFit: "cover" } }) : /* @__PURE__ */ React.createElement("div", { style: { width: "100%", height: "90px", background: "#f1f5f9", color: "#94a3b8", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12 } }, "Tanpa Foto"), /* @__PURE__ */ React.createElement("div", { style: { padding: "8px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", width: "100%", boxSizing: "border-box" } }, /* @__PURE__ */ React.createElement("div", { className: "menu-name", style: { textAlign: "center" } }, m.nama), /* @__PURE__ */ React.createElement("div", { className: "menu-price", style: { textAlign: "center" } }, fmtRp(m.hargaJual)))))), 
          /* @__PURE__ */ React.createElement("h3", { className: "section-title mt12" }, "Box / Paket"), 
          /* @__PURE__ */ React.createElement("div", { className: "menu-grid" }, menus.filter((m) => m.tipe === "paket").map((m) => /* @__PURE__ */ React.createElement("button", { key: m.id, className: "menu-card menu-card-paket", onClick: () => addToCart(m), style: { padding: 0, overflow: "hidden", display: "flex", flexDirection: "column", height: "100%" } }, m.imgUrl ? /* @__PURE__ */ React.createElement("img", { src: m.imgUrl, style: { width: "100%", height: "90px", objectFit: "cover" } }) : /* @__PURE__ */ React.createElement("div", { style: { width: "100%", height: "90px", background: "#f1f5f9", color: "#94a3b8", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12 } }, "Tanpa Foto"), /* @__PURE__ */ React.createElement("div", { style: { padding: "8px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", width: "100%", boxSizing: "border-box" } }, /* @__PURE__ */ React.createElement("div", { className: "menu-name", style: { textAlign: "center" } }, m.nama), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, opacity: 0.7, textAlign: "center" } }, "Isi ", m.isiBox, " pcs"), /* @__PURE__ */ React.createElement("div", { className: "menu-price", style: { textAlign: "center" } }, fmtRp(m.hargaJual)))))), 
          /* @__PURE__ */ React.createElement("h3", { className: "section-title mt12" }, "Toping Tambahan"), 
          /* @__PURE__ */ React.createElement("div", { className: "menu-grid" }, topings.map((t) => /* @__PURE__ */ React.createElement("button", { key: t.id, className: "menu-card menu-card-toping", onClick: () => addToping(t) }, /* @__PURE__ */ React.createElement("div", { className: "menu-name" }, t.nama), /* @__PURE__ */ React.createElement("div", { className: "menu-price" }, fmtRp(t.hargaJual)))))
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "cart-section" }, 
          /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Keranjang"), 
          cart.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada item"), 
          ...
          cart.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, 
            /* @__PURE__ */ React.createElement("div", { className: "cart-total" }, "Total: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(totalBayar))), 
            /* @__PURE__ */ React.createElement("div", { className: "row-wrap" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary", onClick: () => { setCart([]); localStorage.removeItem("evora_cart"); } }, "Batal"), /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: submitTx }, "Simpan Transaksi"))
          ), 
          /* @__PURE__ */ React.createElement("div", { className: "omzet-box mt12" }, /* @__PURE__ */ React.createElement("span", null, "Omzet Hari Ini"), /* @__PURE__ */ React.createElement("strong", null, fmtRp(branchOmzet))), 
          /* @__PURE__ */ React.createElement("div", { className: "omzet-box", style: { borderColor: "#5a1a1a" } }, /* @__PURE__ */ React.createElement("span", null, "Pengeluaran"), /* @__PURE__ */ React.createElement("strong", { style: { color: "#ef4444" } }, fmtRp(branchPeng)))
        )
      ), 
      
      tab === "riwayat" && /* @__PURE__ */ React.createElement("div", null, 
        /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Riwayat - ", txDate), 
        transactions.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada transaksi"), 
        [...transactions].reverse().map((tx) => /* @__PURE__ */ React.createElement("div", { key: tx.id, className: "tx-card" + (tx.edited ? " tx-edited" : "") }, /* @__PURE__ */ React.createElement("div", { className: "tx-header" }, /* @__PURE__ */ React.createElement("span", { className: "tx-id" }, "STRUK-", tx.id.slice(0, 6).toUpperCase()), /* @__PURE__ */ React.createElement("span", { className: "tx-ts" }, tx.ts), tx.edited && /* @__PURE__ */ React.createElement("span", { className: "badge-edit" }, "Diedit")), tx.items.map((it, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "tx-item" }, it.nama, " x", it.qty, " - ", fmtRp(it.hargaJual * it.qty))), /* @__PURE__ */ React.createElement("div", { className: "tx-total" }, "Total: ", fmtRp(tx.total)), /* @__PURE__ */ React.createElement("button", { className: "btn-edit-sm", onClick: () => setEditModal(tx) }, "Edit")))
      ), 
      
      tab === "pengeluaran" && /* @__PURE__ */ React.createElement(PengeluaranLapak, { branchId, branchName: curBranch?.name || "", date: txDate, pushNotif }), 
      
      allowSetoran && tab === "setoran" && /* @__PURE__ */ React.createElement("div", { className: "setoran-box-worker" }, 
        /* @__PURE__ */ React.createElement("div", { className: "setoran-status setoran-" + setoran.status }, setoran.status === "belum" && /* @__PURE__ */ React.createElement("span", null, "Belum Setor"), setoran.status === "menunggu" && /* @__PURE__ */ React.createElement("span", null, "Menunggu Konfirmasi Owner"), setoran.status === "selesai" && /* @__PURE__ */ React.createElement("span", null, "Sudah Setor - Dikonfirmasi")), 
        /* @__PURE__ */ React.createElement("div", { className: "setoran-omzet" }, "Omzet: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(branchOmzet))), 
        /* @__PURE__ */ React.createElement("div", { className: "setoran-omzet" }, "Pengeluaran Lapak: ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#ef4444" } }, fmtRp(branchPeng))), 
        /* @__PURE__ */ React.createElement("div", { className: "setoran-omzet" }, "Bersih Disetor: ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#22c55e" } }, fmtRp(branchOmzet - branchPeng))), 
        setoran.status === "belum" && /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-full", onClick: doSetoran }, "Setor Sekarang"), 
        setoran.status === "menunggu" && /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Menunggu Owner memverifikasi setoran Anda.")
      ), 
      
      tab === "absensi" && /* @__PURE__ */ React.createElement("div", null, 
        /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Absensi"), 
        /* @__PURE__ */ React.createElement("div", { className: "form-card" }, 
          /* @__PURE__ */ React.createElement("div", { className: "row-wrap", style: { justifyContent: "space-between" } }, 
            /* @__PURE__ */ React.createElement("div", null, 
              /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700 } }, "Hari ini"), 
              /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#9a9690" } }, "Check-in: ", fmtTs(todayAbs?.checkin_ts), " | Check-out: ", fmtTs(todayAbs?.checkout_ts))
            ), 
            /* @__PURE__ */ React.createElement("div", { className: "row-wrap" }, 
              /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: doCheckin }, "Check-in"), 
              /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: doCheckout }, "Check-out")
            )
          )
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group mt8" }, 
          /* @__PURE__ */ React.createElement("label", null, "Rekap Bulan"), 
          /* @__PURE__ */ React.createElement("input", { type: "month", className: "inp inp-sm", value: absMonth, onChange: (e) => setAbsMonth(e.target.value) })
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-grid" }, 
          /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-omzet" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Hadir"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, (monthSnap ? monthSnap.total_hadir : calcMonth.hadir), " hari")), 
          /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-profit" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Jam"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, Math.round(((monthSnap ? monthSnap.total_menit : calcMonth.menit) || 0) / 60 * 10) / 10, " jam"))
        ), 
        monthSnap && /* @__PURE__ */ React.createElement("p", { className: "info-txt mt8" }, "Rekap bulan ini sudah dikunci oleh Owner."), 
        /* @__PURE__ */ React.createElement("h3", { className: "section-title mt12" }, "Riwayat Absensi (", absMonth, ")"), 
        myMonthRows.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada absensi."), 
        [...myMonthRows].sort((a, b) => String(b.date).localeCompare(String(a.date))).map((r) => /* @__PURE__ */ React.createElement("div", { key: r.id, className: "peng-row" }, /* @__PURE__ */ React.createElement("div", { className: "peng-info" }, /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, r.date), /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, "In: ", fmtTs(r.checkin_ts), " | Out: ", fmtTs(r.checkout_ts)))))
      ), 
      editModal && /* @__PURE__ */ React.createElement(EditTxModal, { tx: editModal, onClose: () => setEditModal(null), onSave: saveEdit })
    );
  }
  ...
  function PengeluaranLapak({ branchId, branchName, date, pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Pengeluaran Lapak - ", date), 
      /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Catat pengeluaran harian di lapak. Semua dilaporkan ke Owner."), 
      /* @__PURE__ */ React.createElement("div", { className: "chips mt8" }, CHIPS.map((s) => /* @__PURE__ */ React.createElement("button", { key: s, className: "chip", onClick: () => setForm((f) => ({ ...f, keterangan: s })) }, s))), 
      /* @__PURE__ */ React.createElement("div", { className: "form-card mt8" }, 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Keterangan"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: form.keterangan, onChange: (e) => setForm((f) => ({ ...f, keterangan: e.target.value })), placeholder: "Contoh: Beli kantong plastik" })), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Jumlah (Rp)"), /* @__PURE__ */ React.createElement("input", { className: "inp", type: "number", value: form.jumlah, onChange: (e) => setForm((f) => ({ ...f, jumlah: e.target.value })), placeholder: "5000" })), 
        /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: tambah }, "+ Tambah")
      ), 
      list.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt mt8" }, "Belum ada pengeluaran hari ini"), 
      list.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt8" }, list.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, className: "peng-row" }, /* @__PURE__ */ React.createElement("div", { className: "peng-info" }, /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, p.keterangan), /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, p.ts)), /* @__PURE__ */ React.createElement("div", { className: "peng-right" }, /* @__PURE__ */ React.createElement("span", { className: "peng-jml" }, fmtRp(p.jumlah)), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => hapus(p.id) }, "X")))), /* @__PURE__ */ React.createElement("div", { className: "peng-total" }, "Total: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(total))))
    );
  }
  ...
  function EditTxModal({ tx, onClose, onSave }) {
    ...
    return /* @__PURE__ */ React.createElement(Modal, { title: "Edit Transaksi", onClose }, 
      /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Perubahan ini dicatat dan dilaporkan ke Owner."), 
      items.map((it) => /* @__PURE__ */ React.createElement("div", { key: it.id, className: "cart-item" }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1 } }, it.nama), /* @__PURE__ */ React.createElement("input", { type: "number", min: "0", className: "inp inp-sm", style: { width: 60 }, value: it.qty, onChange: (e) => changeQty(it.id, parseInt(e.target.value) || 0) }), /* @__PURE__ */ React.createElement("span", { style: { minWidth: 80, textAlign: "right" } }, fmtRp(it.hargaJual * it.qty)))), 
      /* @__PURE__ */ React.createElement("div", { className: "field-group mt8" }, /* @__PURE__ */ React.createElement("label", null, "Alasan Edit (wajib)"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: alasan, onChange: (e) => setAlasan(e.target.value), placeholder: "Contoh: salah input qty..." })), 
      /* @__PURE__ */ React.createElement("div", { className: "row-wrap mt8" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary", onClick: onClose }, "Batal"), /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: () => { if (!alasan.trim()) { alert("Wajib isi alasan!"); return; } onSave(tx.id, items, alasan); } }, "Simpan"))
    );
  }
  ...
  function OwnerPage({ pushNotif, me }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "page" }, 
      /* @__PURE__ */ React.createElement("div", { className: "page-header" }, 
        /* @__PURE__ */ React.createElement("img", { className: "page-icon", src: "./logo.jpg", style: { width: 45, height: 45, objectFit: "cover", borderRadius: 10, padding: 0 } }), 
        /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", null, "Panel Owner"), /* @__PURE__ */ React.createElement("p", { className: "page-sub" }, "Kontrol penuh bisnis Anda"))
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "tabs tabs-scroll" }, TABS.map((t) => /* @__PURE__ */ React.createElement("button", { key: t, className: "tab" + (tab === t ? " active" : ""), onClick: () => setTab(t) }, TLABEL[t]))), 
      tab === "dashboard" && /* @__PURE__ */ React.createElement(OwnerDashboard, null), 
      tab === "kasir" && /* @__PURE__ */ React.createElement(WorkerPage, { pushNotif, me, mode: "owner" }), 
      tab === "setoran" && /* @__PURE__ */ React.createElement(OwnerSetoran, { pushNotif }), 
      tab === "laporan" && /* @__PURE__ */ React.createElement(OwnerLaporan, null), 
      tab === "absensi" && /* @__PURE__ */ React.createElement(OwnerAbsensi, { pushNotif }), 
      tab === "pengeluaran" && /* @__PURE__ */ React.createElement(PengeluaranOwner, { pushNotif }), 
      tab === "setting" && /* @__PURE__ */ React.createElement(OwnerSetting, { stab, setStab, pushNotif })
    );
  }
  ...
  function OwnerDashboard() {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("div", { className: "filter-bar mb8" }, /* @__PURE__ */ React.createElement("input", { type: "date", className: "inp inp-sm", value: dr.from, onChange: (e) => setDr((r) => ({ ...r, from: e.target.value })) }), /* @__PURE__ */ React.createElement("span", null, "s/d"), /* @__PURE__ */ React.createElement("input", { type: "date", className: "inp inp-sm", value: dr.to, onChange: (e) => setDr((r) => ({ ...r, to: e.target.value })) }), /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: selBranch, onChange: (e) => setSelBranch(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "Semua Cabang"), branches.map((b) => /* @__PURE__ */ React.createElement("option", { key: b.id, value: b.id }, b.name)))), 
      /* @__PURE__ */ React.createElement("div", { className: "kpi-grid" }, 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-omzet" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Omzet"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(omzet))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-modal" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "HPP Bahan"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(modal))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-peng" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Pengeluaran"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(peng))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-profit" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Laba Bersih"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(laba))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-tx" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Transaksi"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fTxs.length, "x")), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-cab" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Cabang"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, branches.length))
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "two-col mt12" }, 
        /* @__PURE__ */ React.createElement("div", { className: "chart-box" }, /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Omzet vs Pengeluaran - 7 Hari"), /* @__PURE__ */ React.createElement(BarChart, { data: chart7, height: 100 }), /* @__PURE__ */ React.createElement("div", { className: "chart-legend mt8" }, /* @__PURE__ */ React.createElement("span", { className: "leg-dot leg-a" }), /* @__PURE__ */ React.createElement("span", null, "Omzet"), /* @__PURE__ */ React.createElement("span", { className: "leg-dot leg-b", style: { marginLeft: 12 } }), /* @__PURE__ */ React.createElement("span", null, "HPP+Peng"))), 
        /* @__PURE__ */ React.createElement("div", { className: "chart-box" }, /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Omzet Per Cabang"), /* @__PURE__ */ React.createElement(BarChart, { data: branchChart, height: 100 }), /* @__PURE__ */ React.createElement("div", { className: "chart-legend mt8" }, /* @__PURE__ */ React.createElement("span", { className: "leg-dot leg-a" }), /* @__PURE__ */ React.createElement("span", null, "Omzet"), /* @__PURE__ */ React.createElement("span", { className: "leg-dot leg-b", style: { marginLeft: 12 } }), /* @__PURE__ */ React.createElement("span", null, "Laba")))
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "two-col mt12" }, 
        /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Performa Cabang"), branchStats.map((b) => /* @__PURE__ */ React.createElement("div", { key: b.id, className: "branch-stat-card" }, /* @__PURE__ */ React.createElement("div", { className: "branch-stat-name" }, b.name, " ", /* @__PURE__ */ React.createElement("span", { className: "badge-type " + b.type }, b.type)), b.workers?.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "branch-workers" }, b.workers.join(", ")), /* @__PURE__ */ React.createElement("div", { className: "branch-stat-row" }, /* @__PURE__ */ React.createElement("span", null, "Omzet"), /* @__PURE__ */ React.createElement("strong", null, fmtRp(b.omzet))), /* @__PURE__ */ React.createElement("div", { className: "branch-stat-row" }, /* @__PURE__ */ React.createElement("span", null, "HPP"), /* @__PURE__ */ React.createElement("strong", null, fmtRp(b.modal))), /* @__PURE__ */ React.createElement("div", { className: "branch-stat-row" }, /* @__PURE__ */ React.createElement("span", null, "Pengeluaran"), /* @__PURE__ */ React.createElement("strong", { style: { color: "#ef4444" } }, fmtRp(b.peng))), /* @__PURE__ */ React.createElement("div", { className: "branch-stat-row" }, /* @__PURE__ */ React.createElement("span", null, "Laba"), /* @__PURE__ */ React.createElement("strong", { style: { color: "#22c55e" } }, fmtRp(b.laba))), /* @__PURE__ */ React.createElement("div", { className: "branch-stat-row" }, /* @__PURE__ */ React.createElement("span", null, "Transaksi"), /* @__PURE__ */ React.createElement("strong", null, b.txCount, "x"))))), 
  ...
  function PengeluaranOwner({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("div", { className: "filter-bar mb8" }, /* @__PURE__ */ React.createElement("input", { type: "date", className: "inp inp-sm", value: date, onChange: (e) => setDate(e.target.value) })), 
      /* @__PURE__ */ React.createElement("div", { className: "form-card" }, /* @__PURE__ */ React.createElement("h4", null, "Tambah Pengeluaran Owner"), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Kategori"), /* @__PURE__ */ React.createElement("select", { className: "inp", value: form.kategori, onChange: (e) => setForm((f) => ({ ...f, kategori: e.target.value })) }, KATEGORI.map((k) => /* @__PURE__ */ React.createElement("option", { key: k.value, value: k.value }, k.label)))), /* @__PURE__ */ React.createElement("div", { className: "chips" }, (CHIPS[form.kategori] || []).map((s) => /* @__PURE__ */ React.createElement("button", { key: s, className: "chip", onClick: () => setForm((f) => ({ ...f, keterangan: s })) }, s))), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Keterangan"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: form.keterangan, onChange: (e) => setForm((f) => ({ ...f, keterangan: e.target.value })), placeholder: "Detail pengeluaran..." })), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Jumlah (Rp)"), /* @__PURE__ */ React.createElement("input", { className: "inp", type: "number", value: form.jumlah, onChange: (e) => setForm((f) => ({ ...f, jumlah: e.target.value })) })), /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: tambah }, "+ Tambah")), 
      byKat.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "kpi-grid mt8" }, byKat.map((k) => /* @__PURE__ */ React.createElement("div", { key: k.value, className: "kpi-card kpi-peng" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, k.label), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(k.total))))), 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Pengeluaran Owner - ", date), 
      filtered.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada pengeluaran"), 
      filtered.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, className: "peng-row" }, /* @__PURE__ */ React.createElement("div", { className: "peng-info" }, /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, p.keterangan), /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, KATEGORI.find((k) => k.value === p.kategori)?.label, " - ", p.ts)), /* @__PURE__ */ React.createElement("div", { className: "peng-right" }, /* @__PURE__ */ React.createElement("span", { className: "peng-jml" }, fmtRp(p.jumlah)), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => hapus(p.id) }, "X")))), 
      filtered.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "peng-total" }, "Total: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(totalHari))), 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt12" }, "Pengeluaran Lapak dari Pekerja - ", date), 
      lapakList.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Tidak ada pengeluaran lapak"), 
      lapakList.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, className: "peng-row" }, /* @__PURE__ */ React.createElement("div", { className: "peng-info" }, /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, p.keterangan), /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, branchesData.find((b) => b.id === p.branchId)?.name || p.branchName, " - ", p.ts)), /* @__PURE__ */ React.createElement("div", { className: "peng-right" }, /* @__PURE__ */ React.createElement("span", { className: "peng-jml" }, fmtRp(p.jumlah))))), 
      lapakList.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "peng-total" }, "Total Lapak: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(lapakList.reduce((a, p) => a + p.jumlah, 0)))))
    );
  }
  ...
  function OwnerSetoran({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("div", { className: "tabs" }, /* @__PURE__ */ React.createElement("button", { className: "tab" + (tab === "harian" ? " active" : ""), onClick: () => setTab("harian") }, "Harian (Pekerja ke Owner)"), /* @__PURE__ */ React.createElement("button", { className: "tab" + (tab === "bulanan" ? " active" : ""), onClick: () => setTab("bulanan") }, "Bulanan (Owner ke Investor)")), 
      tab === "harian" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Status Setoran Harian"), sH.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada setoran masuk"), [...sH].reverse().map((s) => {
  ...
  function OwnerLaporan() {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      ...
      /* @__PURE__ */ React.createElement("div", { className: "kpi-grid" }, 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-omzet" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Omzet"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(omzet))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-modal" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "HPP Bahan"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(modal))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-peng" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Peng. Lapak"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(tPL))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-peng" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Peng. Owner"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(tPO))), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-profit" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Laba Bersih"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, fmtRp(laba)))
      ), 
      editLogs.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt8" }, /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Log Perubahan Kasir"), editLogs.map((log) => /* @__PURE__ */ React.createElement("div", { key: log.id, className: "log-card" }, /* @__PURE__ */ React.createElement("div", { className: "log-header" }, /* @__PURE__ */ React.createElement("span", null, log.ts), /* @__PURE__ */ React.createElement("span", { className: "badge-warn" }, "Diedit Kasir"), /* @__PURE__ */ React.createElement("span", { className: "badge-branch" }, log.branchName || log.branchId)), /* @__PURE__ */ React.createElement("div", { className: "log-detail" }, "STRUK-", log.txId.slice(0, 6).toUpperCase(), ' - Alasan: "', log.alasan, '"'), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#9a9690", marginTop: 4 } }, "Sebelum: ", (log.before || []).map((x) => x.nama + " x" + x.qty).join(", "), " - Sesudah: ", (log.after || []).map((x) => x.nama + " x" + x.qty).join(", "))))), 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Detail Transaksi"), 
      txs.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada transaksi"), 
      txs.map((tx) => /* @__PURE__ */ React.createElement("div", { key: tx.id, className: "tx-card" + (tx.edited ? " tx-edited" : "") }, /* @__PURE__ */ React.createElement("div", { className: "tx-header" }, /* @__PURE__ */ React.createElement("span", { className: "tx-id" }, "STRUK-", tx.id.slice(0, 6).toUpperCase()), /* @__PURE__ */ React.createElement("span", { className: "badge-branch" }, branches.find((b) => b.id === tx.branchId)?.name || tx.branchId), /* @__PURE__ */ React.createElement("span", { className: "tx-ts" }, tx.ts), tx.edited && /* @__PURE__ */ React.createElement("span", { className: "badge-warn" }, "Diedit")), tx.items.map((it, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "tx-item" }, it.nama, " x", it.qty, " = ", fmtRp(it.hargaJual * it.qty), " (HPP: ", fmtRp(it.hpp * it.qty), ")")), /* @__PURE__ */ React.createElement("div", { className: "tx-total" }, "Omzet: ", fmtRp(tx.total), " | HPP: ", fmtRp(tx.totalHPP), " | Laba: ", fmtRp(tx.total - tx.totalHPP)))), 
      pL.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt8" }, /* @__PURE__ */ React.createElement("h3", { className: "section-title" }, "Pengeluaran Lapak"), pL.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, className: "peng-row" }, /* @__PURE__ */ React.createElement("div", { className: "peng-info" }, /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, p.keterangan), /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, branches.find((b) => b.id === p.branchId)?.name || p.branchName, " - ", p.ts)), /* @__PURE__ */ React.createElement("div", { className: "peng-right" }, /* @__PURE__ */ React.createElement("span", { className: "peng-jml" }, fmtRp(p.jumlah))))), /* @__PURE__ */ React.createElement("div", { className: "peng-total" }, "Total Lapak: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(tPL))))
    );
  }
  ...
  function OwnerAbsensi({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("div", { className: "filter-bar mb8" }, /* @__PURE__ */ React.createElement("input", { type: "month", className: "inp inp-sm", value: month, onChange: (e) => setMonth(e.target.value) }), /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: selBranch, onChange: (e) => setSelBranch(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "Semua Cabang"), branches.map((b) => /* @__PURE__ */ React.createElement("option", { key: b.id, value: b.id }, b.name))), /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: lockMonth }, "Kunci Rekap"), /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: unlockMonth }, "Buka Kunci")), 
      /* @__PURE__ */ React.createElement("div", { className: "kpi-grid" }, 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-omzet" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Hadir"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, totalHadir, " hari")), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-profit" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Total Jam"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, Math.round(totalMenit / 60 * 10) / 10, " jam")), 
        /* @__PURE__ */ React.createElement("div", { className: "kpi-card kpi-cab" }, /* @__PURE__ */ React.createElement("div", { className: "kpi-label" }, "Pekerja"), /* @__PURE__ */ React.createElement("div", { className: "kpi-val" }, rows.length))
      ), 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt12" }, "Detail Absensi Bulanan"), 
      rows.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada pekerja / data profiles belum termuat."), 
      rows.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.w.user_id, className: "peng-row", style: { flexDirection: "column", alignItems: "flex-start" } }, 
        /* @__PURE__ */ React.createElement("div", { className: "peng-info", style: { width: "100%", marginBottom: "4px" } }, 
          /* @__PURE__ */ React.createElement("span", { className: "peng-ket" }, r.w.display_name || r.w.email || r.w.user_id.slice(0, 6)), 
          /* @__PURE__ */ React.createElement("span", { className: "peng-ts" }, "Cabang: ", branches.find((b) => b.id === r.w.branchId)?.name || r.w.branchId || "-", " | Hadir: ", r.hadir, " | Jam: ", Math.round(r.menit / 60 * 10) / 10, r.locked ? " | (Terkunci)" : "")
        ), 
        /* @__PURE__ */ React.createElement("div", { style: { paddingLeft: "8px", borderLeft: "2px solid #555", width: "100%", marginTop: "4px" } }, 
          r.history.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: "12px", color: "#888" } }, "Belum ada riwayat absen") : 
          r.history.map(h => /* @__PURE__ */ React.createElement("div", { key: h.id, style: { fontSize: "12px", color: "#ccc", marginBottom: "2px" } }, "• ", h.date, " : Masuk ", getJam(h.checkin_ts), " - Keluar ", h.checkout_ts ? getJam(h.checkout_ts) : "Belum"))
        )
      ))
    );
  }
  ...
  function OwnerSetting({ stab, setStab, pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("div", { className: "tabs tabs-sm" }, TABS.map((t) => /* @__PURE__ */ React.createElement("button", { key: t, className: "tab" + (stab === t ? " active" : ""), onClick: () => setStab(t) }, TLABEL[t]))), 
      stab === "hpp" && /* @__PURE__ */ React.createElement(SettingHPP, { pushNotif }), 
      stab === "paket" && /* @__PURE__ */ React.createElement(SettingPaket, { pushNotif }), 
      stab === "cabang" && /* @__PURE__ */ React.createElement(SettingCabang, { pushNotif }), 
      stab === "akun" && /* @__PURE__ */ React.createElement(SettingAkun, { pushNotif }), 
      stab === "investor" && /* @__PURE__ */ React.createElement(SettingInvestor, { pushNotif }), 
      stab === "data" && /* @__PURE__ */ React.createElement(SettingData, { pushNotif })
    );
  }
        ...
        for (const t of tables) {
          ...
          if (selDate) {
            if (["transactions", "pengeluaranLapak", "pengeluaranOwner", "setoranHarian", "absensi"].includes(t)) {
              ...
              const targetBulan = selDate.slice(0, 7); 
  ...
  function SettingHPP({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("div", { className: "tabs tabs-sm" }, SUB_TABS.map((t) => /* @__PURE__ */ React.createElement("button", { key: t, className: "tab" + (sub === t ? " active" : ""), onClick: () => setSub(t) }, SUB_LABEL[t]))), 
      
      sub === "bahan" && /* @__PURE__ */ React.createElement("div", null, 
        /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Bahan Pokok"), 
        /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Harga per satuan. Otomatis dikalkulasi ke HPP berdasarkan gram di resep."), 
        /* @__PURE__ */ React.createElement("table", { className: "tbl mt8" }, 
          /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Nama"), /* @__PURE__ */ React.createElement("th", null, "Satuan"), /* @__PURE__ */ React.createElement("th", null, "Harga"), /* @__PURE__ */ React.createElement("th", null))), 
          /* @__PURE__ */ React.createElement("tbody", null, bahan.map((b) => /* @__PURE__ */ React.createElement("tr", { key: b.id }, /* @__PURE__ */ React.createElement("td", null, b.nama), /* @__PURE__ */ React.createElement("td", null, b.satuan), /* @__PURE__ */ React.createElement("td", null, fmtRp(b.harga)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => delB(b.id) }, "Hapus")))))
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "add-row" }, 
          /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", placeholder: "Nama bahan", value: nB.nama, onChange: (e) => setNB((x) => ({ ...x, nama: e.target.value })) }), 
          /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: nB.satuan, onChange: (e) => setNB((x) => ({ ...x, satuan: e.target.value })) }, /* @__PURE__ */ React.createElement("option", null, "kg"), /* @__PURE__ */ React.createElement("option", null, "liter"), /* @__PURE__ */ React.createElement("option", null, "gram"), /* @__PURE__ */ React.createElement("option", null, "tabung"), /* @__PURE__ */ React.createElement("option", null, "pcs")), 
          /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "Harga", value: nB.harga, onChange: (e) => setNB((x) => ({ ...x, harga: e.target.value })) }), 
          /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: saveB }, "+ Tambah")
        )
      ), 
      
      sub === "menu" && /* @__PURE__ */ React.createElement("div", null, 
        /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Varian Menu Satuan"), 
        menus.map((m) => /* @__PURE__ */ React.createElement("div", { key: m.id, className: "menu-setting-card" }, 
          /* @__PURE__ */ React.createElement("div", { className: "menu-setting-row" }, /* @__PURE__ */ React.createElement("strong", null, m.nama), /* @__PURE__ */ React.createElement("span", null, "Jual: ", fmtRp(m.hargaJual), " | HPP: ", fmtRp(hitungHPP(m)))), 
          /* @__PURE__ */ React.createElement("div", { className: "menu-setting-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: () => setEditMenu({ ...m }) }, "Edit"), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => delMenu(m.id) }, "Hapus"))
        )), 
        /* @__PURE__ */ React.createElement("button", { className: "btn-primary mt8", onClick: () => setEditMenu({ id: null, nama: "", tipe: "satuan", hargaJual: "", resepBahanPokok: [], resepToping: [], imgUrl: "" }) }, "+ Tambah Menu"), 
        editMenu && /* @__PURE__ */ React.createElement(EditMenuModal, { menu: editMenu, bahan, onSave: saveMenu, onClose: () => setEditMenu(null) })
      ), 
      
      sub === "toping" && /* @__PURE__ */ React.createElement("div", null, 
        /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Toping Tambahan"), 
        /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "HPP toping saja, tidak termasuk bahan pokok."), 
        /* @__PURE__ */ React.createElement("table", { className: "tbl mt8" }, 
          /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Nama"), /* @__PURE__ */ React.createElement("th", null, "Gram"), /* @__PURE__ */ React.createElement("th", null, "HPP"), /* @__PURE__ */ React.createElement("th", null, "Jual"), /* @__PURE__ */ React.createElement("th", null))), 
          /* @__PURE__ */ React.createElement("tbody", null, topings.map((t) => /* @__PURE__ */ React.createElement("tr", { key: t.id }, /* @__PURE__ */ React.createElement("td", null, t.nama), /* @__PURE__ */ React.createElement("td", null, t.gram, "g"), /* @__PURE__ */ React.createElement("td", null, fmtRp(t.hargaBahan)), /* @__PURE__ */ React.createElement("td", null, fmtRp(t.hargaJual)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => delT(t.id) }, "Hapus")))))
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "add-row" }, 
          /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", placeholder: "Nama", value: nT.nama, onChange: (e) => setNT((x) => ({ ...x, nama: e.target.value })) }), 
          /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "Gram", value: nT.gram, onChange: (e) => setNT((x) => ({ ...x, gram: e.target.value })) }), 
          /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "HPP (Rp)", value: nT.hargaBahan, onChange: (e) => setNT((x) => ({ ...x, hargaBahan: e.target.value })) }), 
          /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "Jual (Rp)", value: nT.hargaJual, onChange: (e) => setNT((x) => ({ ...x, hargaJual: e.target.value })) }), 
          /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: saveT }, "+ Tambah")
        )
      )
    );
  }
  ...
  function SettingPaket({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Box / Paket"), 
      /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Menu dijual per box. Resep = total bahan untuk satu box."), 
      pakets.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, className: "menu-setting-card" }, 
        /* @__PURE__ */ React.createElement("div", { className: "menu-setting-row" }, /* @__PURE__ */ React.createElement("strong", null, p.nama), /* @__PURE__ */ React.createElement("span", { className: "badge-paket" }, "Isi ", p.isiBox, " pcs"), /* @__PURE__ */ React.createElement("span", null, "Jual: ", fmtRp(p.hargaJual), " | HPP: ", fmtRp(hitungHPP(p)))), 
        /* @__PURE__ */ React.createElement("div", { className: "menu-setting-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: () => setEditP({ ...p }) }, "Edit"), /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => del(p.id) }, "Hapus"))
      )), 
      /* @__PURE__ */ React.createElement("button", { className: "btn-primary mt8", onClick: () => setEditP({ id: null, nama: "", tipe: "paket", isiBox: 3, hargaJual: "", resepBahanPokok: [], resepToping: [], imgUrl: "" }) }, "+ Tambah Box"), 
      editP && /* @__PURE__ */ React.createElement(EditMenuModal, { menu: editP, bahan, isPaket: true, onSave: save, onClose: () => setEditP(null) })
    );
  }

  function EditMenuModal({ menu, bahan, isPaket, onSave, onClose }) {
    const [m, setM] = useState({ ...menu, tipe: isPaket ? "paket" : "satuan", resepBahanPokok: menu.resepBahanPokok || [], resepToping: menu.resepToping || [], imgUrl: menu.imgUrl || "" });
    ...
    const handleUpload = async (e) => {
      ...
      if (!file) return;
      if (file.size > 2 * 1024 * 1024) { alert("Ukuran foto terlalu besar! Maksimal 2MB bos biar memori HP kasir aman."); return; }
      setUploading(true);
      try {
        const fileExt = file.name.split('.').pop();
        const fileName = `${uid()}.${fileExt}`;
        const { error } = await sb.storage.from("menu-images").upload(fileName, file, { cacheControl: "3600", upsert: false });
        if (error) throw error;
        const { data } = sb.storage.from("menu-images").getPublicUrl(fileName);
        setM((p) => ({ ...p, imgUrl: data.publicUrl }));
      } catch (err) { alert(err?.message || "Gagal upload foto. Pastikan Policy Supabase sudah diatur!"); } finally { setUploading(false); }
    };

    const addRB = () => {
      if (!nRB.bahanId || !nRB.gram) return;
      setM((p) => ({ ...p, resepBahanPokok: [...p.resepBahanPokok, { bahanId: nRB.bahanId, gram: parseFloat(nRB.gram) }] })); setNRB((x) => ({ ...x, gram: "" }));
    };
    ...
    const addRT = () => {
      ...
      setM((p) => ({ ...p, resepToping: [...p.resepToping, { nama: nRT.nama, gram: parseFloat(nRT.gram), harga: parseFloat(nRT.harga) }] })); setNRT({ nama: "", gram: "", harga: "" });
    };
    
    const delRT = (i) => setM((p) => ({ ...p, resepToping: p.resepToping.filter((_, idx) => idx !== i) }));
    const hpp = hitungHPP(m);

    return /* @__PURE__ */ React.createElement(Modal, { title: (isPaket ? "Box - " : "Menu - ") + (m.id ? "Edit" : "Tambah"), onClose }, 
      /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Nama"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: m.nama, onChange: (e) => setM((x) => ({ ...x, nama: e.target.value })) })), 
      /* @__PURE__ */ React.createElement("div", { className: "field-group" }, 
        /* @__PURE__ */ React.createElement("label", null, "Foto Produk (Opsional)"), 
        m.imgUrl && /* @__PURE__ */ React.createElement("img", { src: m.imgUrl, style: { width: 100, height: 100, objectFit: "cover", borderRadius: 8, marginBottom: 8, display: "block", border: "1px solid #444" } }), 
        /* @__PURE__ */ React.createElement("input", { type: "file", accept: "image/*", onChange: handleUpload, disabled: uploading, className: "inp inp-sm" }), 
        uploading && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "#f59e0b", marginTop: 4, display: "block" } }, "Sedang mengunggah foto ke database...")
      ), 
      isPaket && /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Isi Box (pcs)"), /* @__PURE__ */ React.createElement("input", { className: "inp", type: "number", value: m.isiBox || 3, onChange: (e) => setM((x) => ({ ...x, isiBox: parseInt(e.target.value) || 3 })) })), 
      /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Harga Jual"), /* @__PURE__ */ React.createElement("input", { className: "inp", type: "number", value: m.hargaJual, onChange: (e) => setM((x) => ({ ...x, hargaJual: parseFloat(e.target.value) || 0 })) })), 
      /* @__PURE__ */ React.createElement("h4", { className: "sub-title" }, "Resep Bahan Pokok ", isPaket ? "(total untuk " + m.isiBox + " pcs)" : ""), 
      m.resepBahanPokok.map((r, i) => { const b = bahan.find((x) => x.id === r.bahanId); return /* @__PURE__ */ React.createElement("div", { key: i, className: "resep-row" }, b?.nama, " - ", r.gram, "g ", /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => delRB(i) }, "X")); }), 
      /* @__PURE__ */ React.createElement("div", { className: "add-row" }, /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", value: nRB.bahanId, onChange: (e) => setNRB((x) => ({ ...x, bahanId: e.target.value })) }, bahan.map((b) => /* @__PURE__ */ React.createElement("option", { key: b.id, value: b.id }, b.nama))), /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "Gram", value: nRB.gram, onChange: (e) => setNRB((x) => ({ ...x, gram: e.target.value })) }), /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: addRB }, "+")), 
      /* @__PURE__ */ React.createElement("h4", { className: "sub-title" }, "Toping Menu"), 
      m.resepToping.map((t, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "resep-row" }, t.nama, " - ", t.gram, "g - ", fmtRp(t.harga), " ", /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => delRT(i) }, "X"))), 
      /* @__PURE__ */ React.createElement("div", { className: "add-row" }, /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", placeholder: "Nama toping", value: nRT.nama, onChange: (e) => setNRT((x) => ({ ...x, nama: e.target.value })) }), /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "Gram", value: nRT.gram, onChange: (e) => setNRT((x) => ({ ...x, gram: e.target.value })) }), /* @__PURE__ */ React.createElement("input", { className: "inp inp-sm", type: "number", placeholder: "Harga (Rp)", value: nRT.harga, onChange: (e) => setNRT((x) => ({ ...x, harga: e.target.value })) }), /* @__PURE__ */ React.createElement("button", { className: "btn-primary btn-sm", onClick: addRT }, "+")), 
      /* @__PURE__ */ React.createElement("div", { className: "hpp-preview" }, "HPP: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp(hpp)), " | Margin: ", /* @__PURE__ */ React.createElement("strong", null, fmtRp((m.hargaJual || 0) - hpp)), isPaket ? " | Per pcs: " + fmtRp(Math.ceil(hpp / (m.isiBox || 3))) : ""), 
      /* @__PURE__ */ React.createElement("div", { className: "row-wrap mt8" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary", onClick: onClose }, "Batal"), /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: () => { if (!m.nama) { alert("Isi nama!"); return; } onSave(m); } }, "Simpan"))
    );
  }
  ...
  function SettingCabang({ pushNotif }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Kelola Cabang"), 
      branches.map((b) => /* @__PURE__ */ React.createElement("div", { key: b.id, className: "branch-row" }, 
        /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", null, b.name), " ", /* @__PURE__ */ React.createElement("span", { className: "badge-type " + b.type }, b.type), b.workers?.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "branch-workers" }, b.workers.join(", ")), b.type === "investasi" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#9a9690" } }, "Investor: ", investors.find((i) => i.id === b.investorId)?.nama || "-")), 
        /* @__PURE__ */ React.createElement("button", { className: "btn-secondary btn-sm", onClick: () => setEditB({ ...b, ws: (b.workers || []).join(", ") }) }, "Edit"), 
        /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: () => del(b.id) }, "Hapus")
      )), 
      editB && /* @__PURE__ */ React.createElement(Modal, { title: "Edit Cabang", onClose: () => setEditB(null) }, 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Nama Cabang"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: editB.name, onChange: (e) => setEditB((x) => ({ ...x, name: e.target.value })) })), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Nama Pekerja (pisah koma)"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: editB.ws, onChange: (e) => setEditB((x) => ({ ...x, ws: e.target.value })), placeholder: "Andi, Sari, Budi" })), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Tipe"), /* @__PURE__ */ React.createElement("div", { className: "role-tabs" }, /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (editB.type === "mandiri" ? " active" : ""), onClick: () => setEditB((x) => ({ ...x, type: "mandiri" })) }, "Mandiri"), /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (editB.type === "investasi" ? " active" : ""), onClick: () => setEditB((x) => ({ ...x, type: "investasi" })) }, "Investasi"))), 
        editB.type === "investasi" && /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Investor"), /* @__PURE__ */ React.createElement("select", { className: "inp", value: editB.investorId, onChange: (e) => setEditB((x) => ({ ...x, investorId: e.target.value })) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Pilih --"), investors.map((i) => /* @__PURE__ */ React.createElement("option", { key: i.id, value: i.id }, i.nama, " (", i.persenBagi, "%)")))), 
        /* @__PURE__ */ React.createElement("div", { className: "row-wrap mt8" }, /* @__PURE__ */ React.createElement("button", { className: "btn-secondary", onClick: () => setEditB(null) }, "Batal"), /* @__PURE__ */ React.createElement("button", { className: "btn-primary", onClick: saveEdit }, "Simpan"))
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "form-card mt12" }, 
        /* @__PURE__ */ React.createElement("h4", null, "Tambah Cabang Baru"), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Nama Cabang"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: form.nama, onChange: (e) => setForm((x) => ({ ...x, nama: e.target.value })) })), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Nama Pekerja (pisah koma)"), /* @__PURE__ */ React.createElement("input", { className: "inp", value: form.workers, onChange: (e) => setForm((x) => ({ ...x, workers: e.target.value })), placeholder: "Andi, Sari" })), 
        /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Tipe"), /* @__PURE__ */ React.createElement("div", { className: "role-tabs" }, /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (form.type === "mandiri" ? " active" : ""), onClick: () => setForm((x) => ({ ...x, type: "mandiri" })) }, "Mandiri"), /* @__PURE__ */ React.createElement("button", { className: "role-tab" + (form.type === "investasi" ? " active" : ""), onClick: () => setForm((x) => ({ ...x, type: "investasi" })) }, "Investasi"))), 
        form.type === "investasi" && /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("label", null, "Investor"), /* @__PURE__ */ React.createElement("select", { className: "inp", value: form.investorId, onChange: (e) => setForm((x) => ({ ...x, investorId: e.target.value })) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Pilih --"), investors.map((i) => /* @__PURE__ */ React.createElement("option", { key: i.id, value: i.id }, i.nama, " (", i.persenBagi, "%)")))), 
  ...
  function SettingAkun({ pushNotif }) {
    ...
    const [form, setForm] = useState({ role: "worker", email: "", password: "", displayName: "", branchId: branches[0]?.id || "", investorId: investors[0]?.id || "" });
    ...
    const createInvite = async () => {
      ...
      try {
        ...
        const resp = await fetch("/api/create-user", {
          method: "POST", 
          headers: { "Content-Type": "application/json", "Authorization": `Bearer ${token}` },
          body: JSON.stringify({ emailOrUsername: emailFormat, password: pwdInput, role: form.role, displayName: String(form.displayName || "").trim() || null, branchId: form.role === "worker" ? form.branchId : null, investorId: form.role === "investor" ? form.investorId : null })
        });
        const text = await resp.text();
    ...
    const deleteInvite = async (id) => {
      ...
      try { const { error } = await sb.from("invites").delete().eq("id", id); if (error) throw error; refreshInvites(); } catch (e) { pushNotif(e?.message || String(e), "warning"); }
    };
    
    const updateLibur = (userId, hari) => {
      const baru = { ...jadwalLibur, [userId]: hari };
      S.set("jadwalLibur", baru); setJadwalLibur(baru); pushNotif(`Hari libur berhasil diset ke ${hari || "Tidak Ada"}`, "success");
    };

    const filteredProfiles = profiles.filter(p => !deletedIds.includes(p.user_id));

    return /* @__PURE__ */ React.createElement("div", null, 
      /* @__PURE__ */ React.createElement("h3", { className: "section-title mt8" }, "Akun & Invite"), /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Kelola pendaftaran akun pekerja dan investor langsung dengan password dari aplikasi."), 
      /* @__PURE__ */ React.createElement("div", { className: "form-card mt8" }, 
      ...
      filteredProfiles.length > 0 && filteredProfiles.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.user_id, className: "branch-row", style: { alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", null, p.display_name || p.email || p.user_id.slice(0, 8)), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#9a9690" } }, "Role: ", p.role, p.branchId ? ` | Cabang: ${branches.find((b) => b.id === p.branchId)?.name || p.branchId}` : ""), p.role === "worker" && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, marginRight: 8 } }, "Libur:"), /* @__PURE__ */ React.createElement("select", { className: "inp inp-sm", style: { width: "auto", display: "inline-block", padding: "2px 6px", fontSize: 12 }, value: jadwalLibur[p.user_id] || "", onChange: (e) => updateLibur(p.user_id, e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Tidak Libur --"), ["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"].map(h => /* @__PURE__ */ React.createElement("option", { key: h, value: h }, h))))), p.role !== "owner" && /* @__PURE__ */ React.createElement("button", { className: "btn-danger-sm", onClick: async () => { if (!confirm(`Hapus total akun ${p.email || p.display_name}?`)) return; try { const { error } = await sb.rpc("hapus_akun_langsung", { target_user_id: p.user_id, target_email: p.email }); if (error) throw error; setDeletedIds((prev) => [...prev, p.user_id]); pushNotif("Akun berhasil dihapus permanen!", "success"); } catch (err) { pushNotif(err?.message || String(err), "warning"); } } }, "Hapus")))
    );
  }
  ...
  function InvestorPage({ investorId, pushNotif, me }) {
    ...
    const branchChart = branches.map((b) => ({ label: b.name.slice(0, 8), v1: txs.filter((t) => t.branchId === b.id).reduce((a, t) => a + t.total, 0), v2: txs.filter((t) => t.branchId === b.id).reduce((a, t) => a + t.totalHPP, 0) }));
    
    return /* @__PURE__ */ React.createElement("div", { className: "page" }, 
      /* @__PURE__ */ React.createElement("div", { className: "page-header" }, 
        /* @__PURE__ */ React.createElement("img", { className: "page-icon", src: "./logo.jpg", style: { width: 45, height: 45, objectFit: "cover", borderRadius: 10, padding: 0 } }), 
        /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", null, "Portal Investor"), /* @__PURE__ */ React.createElement("p", { className: "page-sub" }, invMe?.nama ? `Akun: ${invMe.nama}` : "Cabang Investasi Saja"))
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "tabs" }, /* @__PURE__ */ React.createElement("button", { className: "tab" + (tab === "harian" ? " active" : ""), onClick: () => setTab("harian") }, "Laporan Harian"), /* @__PURE__ */ React.createElement("button", { className: "tab" + (tab === "bulanan" ? " active" : ""), onClick: () => setTab("bulanan") }, "Laporan Bulanan")), 
      tab === "harian" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "field-group mt8" }, /* @__PURE__ */ React.createElement("label", null, "Pilih Tanggal"), /* @__PURE__ */ React.createElement("input", { type: "date", className: "inp inp-sm", value: selDate, onChange: (e) => setSelDate(e.target.value) })), branches.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "empty-txt" }, "Belum ada cabang investasi."), branches.map((b) => {
        const inv = investors.find((i) => i.id === b.investorId);
  ...
  function App() {
    ...
    const syncAfterLogin = useCallback(async (session) => {
      ...
      if (!session) { 
        S.reset(); setProfile(null); setLoading(false); return; 
      }
      setLoading(true);
      try {
        ...
        if (!prof || prof.role === "none") { 
          pushNotif("Akun kamu belum diundang oleh Owner.", "warning"); 
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, 
      !authSession ? /* @__PURE__ */ React.createElement(LoginPage, null) : 
      /* @__PURE__ */ React.createElement("div", { className: "app-wrap" }, 
        /* @__PURE__ */ React.createElement("nav", { className: "top-nav" }, 
          /* @__PURE__ */ React.createElement("span", { className: "nav-brand" }, "Evora"), 
          /* @__PURE__ */ React.createElement("span", { className: "nav-role" }, profile?.role === "owner" ? "Owner" : profile?.role === "worker" ? "Pekerja" : profile?.role === "investor" ? "Investor" : "\u2014"), 
          /* @__PURE__ */ React.createElement("button", { className: "btn-logout", onClick: () => sb.auth.signOut() }, "Keluar")
        ), 
        /* @__PURE__ */ React.createElement("div", { className: "content-wrap" }, 
          loading && /* @__PURE__ */ React.createElement("p", { className: "info-txt" }, "Memuat data..."), 
          !loading && profile?.role === "worker" && /* @__PURE__ */ React.createElement(WorkerPage, { pushNotif, me: profile }), 
          !loading && profile?.role === "owner" && /* @__PURE__ */ React.createElement(OwnerPage, { pushNotif, me: profile }), 
          !loading && profile?.role === "investor" && /* @__PURE__ */ React.createElement(InvestorPage, { investorId: profile.investorId, pushNotif, me: profile })
        )
      ), 
      /* @__PURE__ */ React.createElement("div", { className: "notif-stack" }, 
        notifs.map((n) => /* @__PURE__ */ React.createElement(Notif, { key: n.id, msg: n.msg, type: n.type, onClose: () => removeNotif(n.id) }))
      )
    );
  }
